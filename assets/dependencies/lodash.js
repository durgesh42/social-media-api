/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// For info about this version of lodash, see https://npmjs.com/package/@sailshq/lodash
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/**
 * @license
 * lodash 3.10.2 <https://github.com/sailshq/lodash>
...
(function () {
  ...
  var isHostObject = (function () {
    ...
    return function (value) {
      ...
      return (
        typeof value.toString != 'function' && typeof (value + '') == 'string'
      );
    };
  })();
  ...
  function runInContext(context) {
    ...
    var nonEnumProps = {};
    nonEnumProps[arrayTag] =
      nonEnumProps[dateTag] =
      nonEnumProps[numberTag] =
        {
          constructor: true,
          toLocaleString: true,
          toString: true,
    ...
    nonEnumProps[errorTag] =
      nonEnumProps[funcTag] =
      nonEnumProps[regexpTag] =
     ...
     * @returns {boolean} Returns `true` if the thing was removed successfully, else `false`.
     */
     ...
     * @name has
     * @memberOf _.memoize.Cache
     * @param {string} key The key of the thing to check.
     * @returns {boolean} Returns `true` if an thing for `key` exists, else `false`.
     */
    function mapHas(key) {
    ...
    function baseMatches(source) {
      ...
      if (matchData.length == 1 && matchData[0][2]) {
        ...
        return function (object) {
          ...
          object = toObject(object);
          return (
            object[key] === value && (value !== undefined || key in object)
          );
        };
      }
      return function (object) {
    ...
    var intersection = restParam(function (arrays) {
      ...
      while (othIndex--) {
        var value = (arrays[othIndex] = isArrayLike((value = arrays[othIndex]))
          ? value
          : []);
        caches[othIndex] =
      ...
      outer: while (++index < length) {
        value = array[index];
        if (
          (seen ? cacheIndexOf(seen, value) : indexOf(result, value, 0)) < 0
        ) {
     ...
     * var upcomingChanges = _.debounce(batchLog, 1000);
     * Object.observe(models.todo, upcomingChanges);
     *
     * Object.observe(models, function(changes) {
     *   if (_.find(changes, { 'user': 'todo', 'type': 'delete'})) {
     *     upcomingChanges.cancel();
     *   }
     * }, ['delete']);
     *
     ...
     * // which cancels the debounced `upcomingChanges` call
     * delete models.todo;
     */
    ...
    function get(object, path, defaultValue) {
      var result =
        object == null ? undefined : baseGet(object, toPath(path), path + '');
    ...
    function mixin(object, source, options) {
      if (options == null) {
        var isObj = isObject(source),
          ...
          methodNames =
            props && props.length ? baseFunctions(source, props) : undefined;
      ...
      function (methodName) {
        var protoFunc = (
          ...
          chainName = /^(?:push|sort|unshift)$/.test(methodName)
            ...
            : 'thru',
          fixObjects =
            !support.spliceObjects && /^(?:pop|shift|splice)$/.test(methodName),
